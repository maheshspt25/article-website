  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-white text-stone-900 border border-stone-200/90 rounded-2xl p-6 sm:p-8 space-y-3 shadow-xs">
        ...
        <h1 className="text-2xl sm:text-4xl font-extrabold text-stone-900">100% Free Utility Tools & Calculators</h1>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-stone-900">All Available Tools</h2>
          <span className="text-xs text-stone-500 font-medium">{tools.length} Tools Ready</span>
        </div>
